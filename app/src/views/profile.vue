    ...
    <div>
        <v-card tile :color="banner_color"  class="px-0 mx-0 w-100 mb-5 pb-1 " min-height="250px" height="250px">
            ...
            <v-overlay :value="overlay" class="w-100" color="#000" style="z-index: 15;">     
                <div class="w-50 p-absolute">
                    <v-card elevation="11" class="container" width="500px" height="600px"  v-click-outside="update_banner"> 
                        ...
                        <v-color-picker dot-size="13" v-model="banner_color"  hide-mode-switch mode="hexa" swatches-max-height="189" class="mx-auto" ></v-color-picker>
                        ...
                        <label class="profile-banner-import-img" for="banner-img-input">
                            ...
                            <div class="ml-4 d-flex" style="position: absolute; z-index: 11;">
                                <v-file-input hide-input accept=".png,.jpg" id="banner-img-input" filled dark dense prepend-icon="mdi-progress-download" v-model="picture_file" ></v-file-input>
                        ...
                        <v-btn class="mt-2" small elevation="" block color="success" plain @click="update_banner('save_banner')">Sauvegarder</v-btn>
                    </v-card>
                </div>
            </v-overlay>
            ...
            <div class="w-80 d-flex container justify-space-between user-bar-bottom align-center banner-footer">
                <div id="profile-creations-count" class="d-flex align-center"><v-icon color="white">mdi-creation</v-icon>0</div>
                <div id="profile-user-namelastname" class="d-flex align-center">
                    <input type="text" :value="name" :disabled="true" class="text-center">
                </div>
                <div id="profile-likes-count" class="d-flex align-center">{{likes}}  <v-icon :color="liked == 1 ? 'red' : 'white'" @click="like_profile">mdi-cards-heart</v-icon>
                </div>
            </div>
        </v-card>        
