...
export default new Vuex.Store({
  ...
  mutations: {
    ...
    setPistPlaylist: function (state, playlist) {
      state.biblio = playlist;
    },
    ...
    updateUser: function (state, data) {
      if (Object.keys(state.user).includes(data.field)) {
    ...
    appendSession: function (state, session) {
    ...
    updateProfileSettings: function (state, data) {
      if (profile_settings.includes(data.field))
        state.profile_settings[data.field] = data.value;
    },
  ...
  actions: {
    ...
    getState: function (context) {
      ...
      return JSON.parse(context.state);
    },
  },
});
